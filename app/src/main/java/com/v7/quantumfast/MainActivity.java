...
public class MainActivity extends Activity {
    ...
    GradientDrawable glassBg(int col,float rad,int alpha){ int fill=Color.argb(alpha, Color.red(col), Color.green(col), Color.blue(col)); GradientDrawable d=new GradientDrawable(); d.setShape(0); d.setCornerRadius(rad); d.setColor(fill); d.setStroke((int)(1.2f*getResources().getDisplayMetrics().density), Color.argb(55,255,255,255)); return d; }
    ...
    void applyGlassTheme(int col){
        try{
            ...
            GradientDrawable bg=new GradientDrawable(); bg.setCornerRadius(32*dens); bg.setColor(Color.argb(60, Color.red(col), Color.green(col), Color.blue(col))); bg.setStroke((int)(1*dens), Color.argb(55,255,255,255));
            ...
            if(dock!=null){ GradientDrawable dBg=new GradientDrawable(); dBg.setCornerRadius(36*dens); dBg.setColor(Color.argb(75, 20,20,20)); dBg.setStroke((int)(1*dens), Color.argb(70,255,255,255)); dock.setBackground(dBg); dock.setElevation(20*dens); }
        }catch(Exception e){}
    }
