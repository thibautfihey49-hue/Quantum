...
public class MainActivity extends Activity {
    ...
    void fixModernFrame(){
        try{
            ...
            if(mainRoot!=null) mainRoot.setPadding((int)(14*d),(int)(30*d),(int)(14*d),(int)(14*d));
            for(int id:new int[]{R.id.searchAppsMain,R.id.searchWebMain}){
                View v=findViewById(id); if(v!=null){ ViewGroup.MarginLayoutParams lp=(ViewGroup.MarginLayoutParams)v.getLayoutParams(); lp.topMargin=(int)(10*d); lp.bottomMargin=(int)(10*d); lp.leftMargin=(int)(14*d); lp.rightMargin=(int)(14*d); v.setLayoutParams(lp); }
            }
        }catch(Exception e){}
    }
