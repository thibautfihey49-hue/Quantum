...
void saveFolders(){ StringBuilder sb=new StringBuilder(); for(int i=0;i<folders.size();i++){ if(i>0) sb.append(";;"); sb.append(folders.get(i).name).append("||").append(String.join(",",folders.get(i).pkgs)); } prefs.edit().putString("folders",sb.toString()).apply(); }
 ...
 void updateDockIcon(ImageView iv, String pkg){
    ...
    android.graphics.drawable.Drawable createGlassDrawable(int col, float rad, int alpha){
        int fill=android.graphics.Color.argb(alpha, android.graphics.Color.red(col), android.graphics.Color.green(col), android.graphics.Color.blue(col));
        android.graphics.drawable.GradientDrawable d=new android.graphics.drawable.GradientDrawable();
        d.setShape(android.graphics.drawable.GradientDrawable.RECTANGLE);
        d.setCornerRadius(rad);
        d.setColor(fill);
        d.setStroke((int)(1.2f*getResources().getDisplayMetrics().density), android.graphics.Color.argb(110,255,255,255));
        return d;
    }
    ...
    void showPaletteDialog(){
        ...
        TextView preview=new TextView(this); preview.setText(" Aperçu verre "); preview.setTextSize(16); preview.setPadding((int)(16*dens),(int)(12*dens),(int)(16*dens),(int)(12*dens)); preview.setBackground(createGlassDrawable(0xFFFFD4E7, 18*dens, 85)); root.addView(preview);
