 ...
 void updateDockIcon(ImageView iv, String pkg){
    ...
    void boostAllApps(){
        try{
            ...
            try{
                rvSugg.setHasFixedSize(true);
                rvSugg.setItemAnimator(null);
                rvSugg.setLayerType(android.view.View.LAYER_TYPE_HARDWARE,null);
                rvSugg.setOverScrollMode(android.view.View.OVER_SCROLL_NEVER);
                ((androidx.recyclerview.widget.LinearLayoutManager)rvSugg.getLayoutManager()).setInitialPrefetchItemCount(100);
                rvSugg.setItemViewCacheSize(1000);
            }catch(Exception e){}
