...
public class MainActivity extends Activity {
    ...
    void showBrowserChooser(String query){
        ...
        new android.app.AlertDialog.Builder(this, android.R.style.Theme_Translucent_NoTitleBar).setTitle("Choisir navigateur pour: "+query)
           .setItems(names, (d,which)->{
                ...
                }catch(Exception e){ Toast.makeText(this,"Erreur",Toast.LENGTH_SHORT).show(); }
            })
    ...
    void openDrawerWithQuery(String initial){
        ...
        dlg.setContentView(R.layout.drawer); RecyclerView rv=dlg.findViewById(R.id.recycler); EditText s=dlg.findViewById(R.id.search);
